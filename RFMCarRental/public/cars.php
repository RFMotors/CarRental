    ...
    <div class="sidebar-wrapper">
        ...
        <aside class="filter-sidebar">
            ...
            <form method="GET" id="filterForm">
                ...
                <input type="text" name="make" id="make" placeholder="Toyota" value="<?= htmlspecialchars($make) ?>">

                <label for="model">Model</label>
                <input type="text" name="model" id="model" placeholder="Yaris" value="<?= htmlspecialchars($model) ?>">

                <label for="minYear">Min Year</label>
                <input type="number" name="minYear" id="minYear" placeholder="2005" value="<?= htmlspecialchars($minYear) ?>">

                <label for="maxYear">Max Year</label>
                <input type="number" name="maxYear" id="maxYear" placeholder="2025" value="<?= htmlspecialchars($maxYear) ?>">
